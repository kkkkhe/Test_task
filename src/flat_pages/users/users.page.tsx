...
import { CreateForm, EditForm, createUserThunk, editUserThunk } from "@/src/features/manage-user";
...
export const UsersPage = () => {
  ...
  const setCreateUserModalOpened = useAction(userModel.actions.setUserCreatingState);
  return (
          ...
          <div className="flex justify-end pt-5 w-full">
            <div className="w-[60%] flex justify-between items-center ">
              ...
              <button 
                ...
                onClick={() => setCreateUserModalOpened(true)}>Create User</button>
            </div>
          </div>
          <Modal isOpened={isUserCreatingModalOpened} onClose={() => setCreateUserModalOpened(false)}>
